...
export default function PostCard() {
  return (
    <Card>
      ...
      {/* Content */}
      <div>
        <p className="my-3 text-sm">Nulla laboris labore nisi id consectetur culpa sit adipisicing ea aute aliquip consequat. Duis officia ad qui reprehenderit sunt sunt in.</p>
